...
pub const RCON_TYPE_LOGIN: i32 = 3;
...
impl RconClient {
    ...
    pub fn send_packet(&mut self, id: i32, ty: i32, body: &[u8]) -> Result<()> {
        use std::io::Write;
    ...
    pub fn recv_packet(&mut self) -> Result<(i32, i32, String)> {
        use std::io::Read;
...
pub fn rcon_settings(props: &[(String, String)]) -> Option<(String, u16, String)> {
