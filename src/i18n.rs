...
pub struct Strings {
    ...
    pub rcon_disabled_in_props: &'static str,
    pub rcon_prompt_label: &'static str,
    pub rcon_prompt_title: &'static str,
    pub rcon_history_empty: &'static str,
    pub rcon_response_label: &'static str,
